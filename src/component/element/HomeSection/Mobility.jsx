...
const Mobility = () => {
  return (
    <div className=" mobility_section padding-block padding-inline grid lg:grid-cols-2 grid-cols-1  place-items-center xl:gap-x-[80px] lg:gap-x-[20px]  ">
      <div className="">
        <h2 className="xl:text-[45px] lg:text-[40px] text-[30px]  font-[600]  xl:leading-[55px]  lg:leading-[50px] leading-none mb-[30px] ">
      ...
      <div className="mobility_content">
        <p className="text-justify text-gray text-[20px] lg:block hidden xl:ps-0 lg:ps-[20px]">
          At Qwikio Inc, we're not just making electric vehicles; we're igniting
          a movement. Our vision? To transform how you travel with
          groundbreaking technology and sustainable design.
        </p>
